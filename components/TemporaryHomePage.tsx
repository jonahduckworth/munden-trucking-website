...
const TemporaryHomePage = () => {
  ...
  const taglines = [
    ...
    'CVIP Inspections & Emergency Roadside Repair',
    'Welding, Fabrication & Hydraulics Specialists',
  ];
  ...
  const services = [
    {
      ...
      description:
        'Kamloops truck repair, trailer repair, engine repair, suspension repair, mechanical repair',
    ...
    },
    {
      ...
      description:
        'CVIP, MVI, CVI truck inspection and trailer inspection facility in Kamloops',
      href: '/services/repair-shop/commercial-vehicle-inspections',
    },
    {
      icon: Truck,
      title: 'Mobile Service Truck',
      description:
        'Kamloops mobile service, service truck, emergency service, roadside repair, service call',
    ...
    },
    {
      ...
      description:
        'Welding, fabrication, hydraulics, A/C repair, refrigeration trailer, reefer, Carrier, Thermo King, Webasto, Espar',
      href: '/services',
    },
  ];
          ...
          >
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center mb-12'>
              ...
              <Button size='lg' variant='outline' asChild>
                <a
                  href='https://www.google.com/maps/search/?api=1&query=725+Carrier+Street,+Kamloops,+BC+V2H+1G1'
                  target='_blank'
        ...
        <div className='container'>
          ...
          >
            <h2 className='text-3xl md:text-4xl font-bold mb-4'>
              Kamloops Truck Repair Services
            </h2>
            <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
              Full service truck shop, trailer shop, automotive shop offering
              mechanical repair, emergency repair and roadside service 24/7
            </p>
          </motion.div>
        ...
        <div className='container'>
          ...
          >
            ...
            <p className='text-xl mb-8 text-gray-200'>
              Expert mechanics providing truck repair, trailer repair, equipment
              repair, maintenance and parts in Kamloops
            </p>
        ...
        <div className='container'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8 text-center'>
            ...
            >
              ...
              <p className='text-muted-foreground'>CVIP MVI CVI Inspections</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
