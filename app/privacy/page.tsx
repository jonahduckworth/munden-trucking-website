          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                <p>
                  Munden Truck & Equipment Ltd. ("we," "our," or "us") is
                ...
                <ul>
                  ...
                  <li>
                    <strong>Vehicle Information:</strong> Make, model, year, and
                    service history of vehicles you bring for service
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    Send administrative information, such as updates and
                    security alerts
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    <strong>Service Providers:</strong> With third parties that
                    perform services on our behalf
                  </li>
                  <li>
                    <strong>Business Partners:</strong> With equipment
                    manufacturers and parts suppliers as necessary
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Consent:</strong> With your consent or at your
                    direction
                  </li>
                </ul>
                ...
                <p>
                  ...
                  third-party sites. We encourage you to read their privacy
                  policies.
                </p>
