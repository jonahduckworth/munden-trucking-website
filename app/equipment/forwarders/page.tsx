...
export default function ForwardersPage() {
  const productListSchema = {
    ...
    description:
      "New EcoLog forwarder models available at Munden Truck & Equipment",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              ...
              Superior load capacity, excellent maneuverability, and operator
              comfort for maximum productivity.
            </p>
              ...
              <div className="space-y-2">
                ...
                <Select defaultValue="featured">
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="capacity-high">
                      Capacity (High-Low)
                    </SelectItem>
                    <SelectItem value="capacity-low">
                      Capacity (Low-High)
                    </SelectItem>
                  </SelectContent>
                </Select>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-4">
                    <Button asChild className="flex-1">
                      <Link href={`/equipment/forwarders/${forwarder.id}`}>
                        View Details
                      </Link>
                    </Button>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">
              Compare specifications and features to find the perfect forwarder
              for your operation.
            </p>
          </div>
          <EquipmentComparison />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    EcoLog forwarders are designed to carry maximum payloads
                    while maintaining stability and maneuverability in
                    challenging terrain.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Powerful, precise cranes with exceptional reach and control
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Engineered to minimize environmental impact with wide tires
                    and balanced weight distribution for superior flotation.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center text-sm">
                      <span className="w-1.5 h-1.5 bg-blue-600 rounded-full mr-2" />
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">
                    Spacious, ergonomic cabs with excellent visibility and
                    comfort features reduce operator fatigue and increase
                    productivity.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center text-sm">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 opacity-90">
              Our EcoLog forwarders deliver the performance and reliability you
              need. Contact us to find the right model for your logging
              operation.
            </p>
