  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 4,
        name: forwarder.model,
        item: `https://mundentruckandequipment.com/equipment/forwarders/${model}`,
      },
    ],
  };
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {forwarder.specifications.Engine["Power Output"]}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {forwarder.specifications["Load Area"]["Load Capacity"]}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {forwarder.specifications.Crane.Reach}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-semibold">
                      {forwarder.specifications.Dimensions.Weight}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs defaultValue="features" className="space-y-8">
            ...
            <TabsContent value="specifications">
              <SpecificationTable
                specifications={Object.entries(forwarder.specifications).map(
                  ([title, specs]) => ({
                    title,
