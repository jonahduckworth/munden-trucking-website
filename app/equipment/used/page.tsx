...
export const metadata: Metadata = {
  title:
    "Used Forestry Equipment | Pre-Owned Harvesters & Forwarders | Munden Truck",
  description:
    "Quality used forestry equipment including harvesters, forwarders, and logging trucks. All equipment inspected and serviced. Warranty available.",
};
...
export default function UsedEquipmentPage() {
  const productListSchema = {
    ...
    description:
      "Pre-owned forestry equipment available at Munden Truck & Equipment",
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/contact">Sell Your Equipment</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-muted-foreground">
                Showing {usedEquipment.length} of {usedEquipment.length}{" "}
                equipment
              </p>
              ...
              <Card key={item.id} className="overflow-hidden">
                <div className="aspect-video relative bg-muted">
                  ...
                  <div className="absolute top-4 left-4 right-4 flex justify-between">
                    <Badge
                      variant={
                        item.status === "certified" ? "default" : "secondary"
                      }
                    >
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Every certified pre-owned machine undergoes our comprehensive
                inspection
              </p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Comprehensive mechanical, hydraulic, and electrical system
                    checks by certified technicians.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    All necessary repairs completed using genuine parts. Full
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Equipment tested under working conditions to ensure
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Certified equipment includes warranty options for major
            ...
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-8 lg:p-12">
                ...
                <p className="text-muted-foreground mb-6">
                  Get top dollar for your current equipment. We accept trade-ins
                  on all purchases and offer competitive valuations based on
                ...
                <Button size="lg" asChild>
                  <Link href="/contact">Get Trade-In Value</Link>
                </Button>
              </div>
