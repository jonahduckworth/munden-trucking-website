      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Use our instant calculator for common services or request a custom
            quote
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-red-700 dark:text-red-200">
                  For immediate roadside assistance or urgent repairs, call us
                  now
                </p>
              </div>
              <Button
              ...
              <CardContent>
                {submitSuccess ? (
                  <Alert className="mb-6">
                    ...
                    <AlertDescription>
                      Thank you for your quote request! We&apos;ll send you a
                      detailed quote within 24 hours.
                    </AlertDescription>
                  </Alert>
                ) : (
                    ...
                    >
                            ...
                            <FormItem>
                              ...
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="equipment-purchase">
                                    Equipment Purchase
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                  ...
                                  <div className="space-y-1 leading-none">
                                    <FormLabel>CVIP Inspections</FormLabel>
                                  </div>
                                </FormItem>
                              )}
                            />
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          If applicable, provide details about your equipment or
                          vehicle
                        </p>
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    placeholder="e.g., Truck, Harvester"
                                    {...field}
                                  />
                                </FormControl>
                                <FormMessage />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                The more details you provide, the more accurate
                                your quote will be
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
