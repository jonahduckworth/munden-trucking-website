          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card>
              ...
              <CardContent className="prose prose-gray dark:prose-invert max-w-none">
                <p>
                  Welcome to Munden Truck & Equipment Ltd. These Terms of
                ...
                <p>
                  Service appointments are subject to availability. We reserve
                ...
                <ul>
                  <li>
                    All prices are in Canadian dollars and subject to applicable
                    taxes
                  </li>
                  <li>
                    Quotes are estimates only and final pricing may vary based
                  ...
                  <li>
                    We accept cash, credit cards, and approved commercial
                    accounts
                  </li>
                </ul>
                ...
                <p>
                  <strong>Service Warranty:</strong> We warrant our repair
                  services for 90 days or 5,000 km, whichever comes first. This
                  warranty covers defects in workmanship but does not cover
                  normal wear and tear or damage caused by misuse.
                </p>
                <p>
                  <strong>Parts Warranty:</strong> Parts are covered by the
                  manufacturer&apos;s warranty. We will assist with warranty
                  claims but are not responsible for manufacturer warranty
                  terms.
                </p>
                <p>
                ...
                <p>
                  To the maximum extent permitted by law, Munden Truck &
                  Equipment Ltd. shall not be liable for any indirect,
                ...
                <p>
                  You agree to indemnify and hold harmless Munden Truck &
                  Equipment Ltd., its affiliates, and their respective officers,
                  directors, employees, and agents from any claims, damages,
                  losses, liabilities, and expenses arising out of your use of
                ...
                <p>
                  ...
                  images, and software, is the property of Munden Truck &
                  Equipment Ltd. or its licensors and is protected by
                ...
                <p>
                  ...
                  the laws of British Columbia, Canada, without regard to its
